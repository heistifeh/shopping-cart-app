...
const CartButton = ({ product }: { product: Product}) => {
    const inCart = false; // Replace with actual cart state logic
    const item = { ...product, quantity: 1 }; // Replace with actual item logic
  return (
    <div className={`w-max absolute right-5 top-5 scale-90`}>
